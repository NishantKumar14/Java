...
class JDBCTest{
    ...
    public static void main(String args[]) {
        ...
        ("insert into emp (id, name)values(15,'KNOCKCAT')"); st.executeUpdate
        ("insert into emp(id, name)values(10,'VISHAL')"); } catch
        (Exception e){ System.out.println("query not found"); }
